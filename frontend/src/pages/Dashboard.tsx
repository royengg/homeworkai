      ...
      <section className="flex flex-col md:flex-row md:items-end justify-between gap-8 pb-4">
        <div className="space-y-3">
          <div className="flex items-center gap-3">
             ...
             <span className="text-[10px] font-mono-alt uppercase tracking-[0.3em] text-[#3b3a37] dark:text-[#b9b3aa]">Personal Hub</span>
          </div>
          <h1 className="text-5xl font-black tracking-tight">
            Documents
          </h1>
          <p className="text-[#3b3a37] dark:text-[#b9b3aa] text-sm font-medium max-w-sm leading-relaxed">
            Organize your PDFs, track analysis, and open clean solutions on demand.
          </p>
        </div>
